...
Object(_navigation__WEBPACK_IMPORTED_MODULE_0__["slideup"])();
/**
...
function slideup() {
  ...
  SlideupHandler.prototype = {
    init: function init() {
      ...
      window.addEventListener('resize', lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(this.resizeHandler.bind(this), 50));
      this.resizeHandler();
    },
    ...
    bind: function bind() {
      ...
      this.el.$close.addEventListener('click', this.listeners.close); // Add support for Turbolinks

      document.addEventListener('turbolinks:visit', this.listeners.close);
      document.addEventListener('turbolinks:visit', this.listeners.transitionCompleteClose); // Set menu state to hidden. This makes all child elements unfocusable.
    ...
    unbind: function unbind() {
      ...
      document.removeEventListener('turbolinks:visit', this.listeners.transitionCompleteClose); // Remove ARIA roles

      this.el.$menu.removeAttribute('hidden');
    },
    addAnimationListeners: function addAnimationListeners() {
      // Add event listeners for different browser transition names.
      this.eventTypes.transitionEnd.forEach(function (transition) {
        this.el.$menu.addEventListener(transition, this.listeners.handleTransitionComplete);
      }.bind(this));
    },
    removeAnimationListeners: function removeAnimationListeners() {
      // Remove event listeners for different browser transition names.
      this.eventTypes.transitionEnd.forEach(function (transition) {
        this.el.$menu.removeEventListener(transition, this.listeners.handleTransitionComplete);
      }.bind(this));
    },
    handleTransitionComplete: function handleTransitionComplete(evt) {
    ...
    transitionCompleteOpen: function transitionCompleteOpen() {
      this.isOpen = true;
      document.documentElement.classList.remove(this.options.classes.isOpening);
    },
    transitionCompleteClose: function transitionCompleteClose() {
      this.isOpen = false;
      document.documentElement.classList.remove(this.options.classes.isClosing, this.options.classes.isOpen);
    },
    ...
    setAriaStates: function setAriaStates(expanded) {
...
/***/ 0:
/*!************************************************************************************!*\
  !*** multi ./assets/js/app.js ./assets/sass/styles.scss ./assets/sass/mobile.scss ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/johnkeough/Sites/timber/docs/assets/js/app.js */"./assets/js/app.js");
__webpack_require__(/*! /Users/johnkeough/Sites/timber/docs/assets/sass/styles.scss */"./assets/sass/styles.scss");
module.exports = __webpack_require__(/*! /Users/johnkeough/Sites/timber/docs/assets/sass/mobile.scss */"./assets/sass/mobile.scss");
